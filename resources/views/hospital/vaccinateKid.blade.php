                ...
                <div class="col-lg-7">
                    <div class="card shadow-lg border-0 rounded-lg mt-5">
                        <div class="card-header">
                            <h3 class="text-center font-weight-light my-4">Viccinate a Kid</h3>
                        ...
                        <div class="card-body">
                            ...
                            <h5 class="text-center font-weight-light ">Next Visitation:{{$formattednextAdminDays}}</h5>
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control" id="inputname" value="{{$nextAdminDate}}" name="vaccine_" type="date" placeholder="Enter user name"  required autocomplete="kid_name"/>
